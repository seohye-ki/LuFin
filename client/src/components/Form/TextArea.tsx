...
const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(
  ({ label, description, error, isDisabled, className = '', ...props }, ref) => {
    const baseInputClasses = "block w-full rounded-md bg-white px-3 py-1.5 text-p1 text-black outline-1 -outline-offset-1 outline-broken-white placeholder:text-p2 placeholder:text-grey-25 focus:outline-2 focus:-outline-offset-2 focus:outline-info sm:text-sm/6 resize-none";
