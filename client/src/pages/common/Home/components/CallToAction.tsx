...
export function CallToAction() {
  ...
  return (
    <div id='cta-section' className='relative isolate px-6 py-32 sm:py-40 lg:px-8 overflow-hidden'>
      {/* 백그라운드 장식 효과 */}
      <div className='absolute inset-0 -z-10'>
        <div
          className='absolute right-1/2 bottom-0 -translate-y-1/2 transform-gpu blur-3xl sm:right-full sm:-translate-x-1/2 lg:bottom-0 lg:right-0 lg:translate-x-0 lg:translate-y-0'
          aria-hidden='true'
        >
          <div
            className='aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-info/20 to-info/5 opacity-20'
            style={{
              clipPath:
          ...
          <div className='relative order-1 lg:order-2 flex justify-center'>
            <div className='relative w-full max-w-lg'>
              ...
              <div className='relative z-10 transform transition-all duration-500 hover:scale-105'>
                <img src={tabletDashboardMission} alt='루핀 미션 대시보드' />
              </div>
            </div>
          </div>
        </div>
