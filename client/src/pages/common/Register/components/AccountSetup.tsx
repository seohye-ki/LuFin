...
interface AccountSetupProps {
  ...
  onChange: (field: 'accountPassword' | 'confirmAccountPassword') => (e: React.ChangeEvent<HTMLInputElement>) => void;
  onBlur: (field: 'accountPassword' | 'confirmAccountPassword') => (e: React.FocusEvent<HTMLInputElement>) => void;
  onPrev: () => void;
  onNext: () => void;
}
    ...
    <div className="space-y-4 transition-all duration-300">
      <TextField
        ...
        variant={accountPassword 
          ? (/^\d{6}$/.test(accountPassword) ? 'success' : 'error')
          : 'normal'}
      ...
      <TextField
        ...
        variant={confirmAccountPassword
          ? (accountPassword === confirmAccountPassword ? 'success' : 'error')
          : 'normal'}
        description={confirmAccountPassword
