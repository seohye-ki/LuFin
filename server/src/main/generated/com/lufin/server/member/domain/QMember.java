...
public class QMember extends EntityPathBase<Member> {
    ...
    public final SetPath<com.lufin.server.mission.domain.MissionParticipation, com.lufin.server.mission.domain.QMissionParticipation> missionParticipations = this.<com.lufin.server.mission.domain.MissionParticipation, com.lufin.server.mission.domain.QMissionParticipation>createSet("missionParticipations", com.lufin.server.mission.domain.MissionParticipation.class, com.lufin.server.mission.domain.QMissionParticipation.class, PathInits.DIRECT2);
