...
public class QMemberStatus extends BeanPath<MemberStatus> {
    ...
    public final NumberPath<Byte> activationStatus = createNumber("activationStatus", Byte.class);

    public final NumberPath<Integer> creditRating = createNumber("creditRating", Integer.class);

    public final NumberPath<Byte> creditStatus = createNumber("creditStatus", Byte.class);

    public final StringPath creditStatusDescription = createString("creditStatusDescription");
