...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='학급 정보';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='회원-학급 관계';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='적금 상품';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='적금 계좌';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='적금 거래 내역';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='대출 상품';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='대출 신청';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='대출 내역';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='주식 상품';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='주식 가격 변동 내역';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='주식 포트폴리오';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='주식 거래 내역';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='아이템 템플릿';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='아이템 정보';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='아이템 구매';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='아이템 사용 요청';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='주식 뉴스';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='직업 정보';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='직업 신청';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='미션 정보';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='미션 이미지';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='미션 참여';
